...
long double Cpart7(long double s,long double s1,long double s2,long double t1,long double t2){
    ...
    long double a=((-((2 - 4*s + 6*s1 - 2*s2 + 2*s1*s2 - 4*t1 + 4*s1*t1 + 8*t2 + 8*s*t2 + 
           4*s2*t2 - 4*s1*s2*t2 - 
           ...
           ((-1 + s1)*(-1 + t2)*
            ...
            ((-1 + s2)*(-1 + t1)))/
         (Power(Pi,2)*Power(-1 + s1,2)*Power(-1 + t2,2))) - 
...
+ ((s - s1 + t2)*(-21 + 23*t1 - 9*s1*t1 - 2*Power(t1,2) + 
      ...
      (2*(3 - 3*s2 + 6*Power(s2,2) - Power(s2,3) - 6*t1 + 6*s2*t1 - 
         ...
         ((-1 + s2)*(-5 + 4*s2 - 4*Power(s2,2) + 5*t1 - 8*s2*t1 + 
              ...
              t2 - 7*s2*t2 + 2*Power(s2,2)*t2 - 2*t1*t2 + 2*s2*t1*t2 - 
              s*(4 - 7*t1 + 2*Power(t1,2) - 3*t2 + 2*t1*t2 + 
                 2*s2*(-2 + t1 + t2)) + 
         ...
         (2*(-1 + s2)*(-1 + t1)*
            (-3 - Power(s1,2) - 4*s2 - 4*Power(s2,2) + 2*Power(s2,3) + 
              ...
              s1*(-1 + 2*Power(s2,2) + Power(t1,2) - t1*(-2 + t2) + 
                 t2 + s2*(-3 - 3*t1 + 2*t2)) - 
              s*(-1 + 3*Power(s2,2) + 2*t1 + Power(t1,2) + t2 - t1*t2 + 
                 s1*(-4 + s2 - t1 + t2) + s2*(-5 - 4*t1 + 3*t2))))/
          ((s - s2 + t1)*(s - s1 + t2)))/
       (Power(Pi,2)*Power(-1 + s2,2)*Power(-1 + t1,2)) - 
      (-2*(-2 + Power(s,2)*(-1 + s2) - 7*s2 - 6*Power(s2,2) + 
            Power(s2,3) + 7*s2*t1 - Power(s2,2)*t1 - Power(t1,2) + 
            s1*(-2 + 2*s2 + Power(s2,2) - t1 - s2*t1) - 
            s*(-4 + s1 - 6*s2 + s1*s2 + 2*Power(s2,2) + 2*t1 - s2*t1) + 
            t2 + s2*t2) + ((-1 + s2)*
            (-7 - 2*Power(s1,2) - 21*s2 - 2*Power(s2,2) + 
              ...
              s*(17 - 4*Power(s2,2) - 8*t1 - Power(t1,2) + 
                 ...
                 t1*t2)))/(s - s1 + t2) + 
         ((s - s2 + t1)*(-2*Power(s,2) - 7*s2 - 8*Power(s2,2) - 2*t1 + 
              s2*t1 + 2*Power(s2,2)*t1 + 2*Power(t1,2) + 
         ...
         ((-1 + s2)*(-s + s2 - t1)*
            (9 - 3*s2 - 2*Power(s2,2) + 2*Power(s1,2)*(1 + s2 - t1) + 
              ...
              s1*(4 + Power(s2,2) - Power(t1,2) + s2*(-1 + t2) - 
                 2*t2 + t1*(5 + t2)) + 
              s*(-3 - 8*t1 + Power(t1,2) + s2*(8 + t1 - 4*t2) + 2*t2 + 
                 Power(t2,2) - s1*(-2 + s2 - 3*t1 + 2*t2))))/
          ((-1 + s1)*(-1 + t2)) - 
         ((-1 + s2)*(-s + s2 - t1)*
            (-9*s2 + 6*Power(s2,2) - 6*t1 - 9*s2*t1 - 2*Power(t1,2) + 
              2*s2*Power(t1,2) + Power(s1,2)*(-2 + s2 + t1) + 9*s2*t2 - 
              3*Power(s2,2)*t2 + 2*Power(t2,2) - 
              Power(s,2)*(-2 + t1 + t2) + 
              s1*(-3 + Power(s2,2) - 3*t1 + 2*Power(t1,2) + 
                 s2*(-2 + t1 - 3*t2) + t2) + 
              s*(3 + 3*t1 - 2*Power(t1,2) - 5*t2 + s1*(2 - s2 + t2) + 
                 s2*(-8 + t1 + 4*t2))))/((-1 + t1)*(-1 + t2)))/
       (Power(Pi,2)*Power(-1 + s2,2)*Power(s - s2 + t1,2)) - 
      (2*(1 + 3*s2 - 2*t1 - s2*t1 + 2*Power(t1,2) - 2*t2 + 5*t1*t2 - 
         ...
         ((-1 + t1)*(-1 + t2)*
          ...
          ((-1 + s2)*(-s + s2 - t1)) - 
         ((-1 + t1)*(-1 + t2)*
            (-3 - 7*s2 + 6*Power(s2,2) + 2*Power(s1,2)*(-1 + s2 - t1) + 
              2*t1 - 11*s2*t1 + Power(t1,2) + 8*s2*t2 - 
              3*Power(s2,2)*t2 - 4*t1*t2 + 5*s2*t1*t2 + Power(t2,2) - 
              s2*Power(t2,2) - Power(s,2)*(-2 + t1 + t2) + 
              ...
              s1*(-6 + Power(s2,2) - Power(t1,2) + 4*t2 - 
                 s2*(1 + 3*t2) + t1*(-7 + 5*t2))))/
          ((s - s2 + t1)*(s - s1 + t2)))/
       (Power(Pi,2)*Power(-1 + t1,2)*Power(-1 + t2,2)) - 
      ((2*(-1 + s1)*(-s + s1 - t2)*
         ...
         (2*(-1 + s1)*(-s + s1 - t2)*
            (-16 - Power(s,2) + Power(s1,2) + 3*s2 + Power(s2,2) + 
              ...
              s1*(3 - 5*s2 + 4*t1 - 3*t2) + s*(3 + s1 + s2 - t1 - t2) + 
              2*t2 + 4*s2*t2 - 5*t1*t2 + 2*Power(t2,2)))/
          ((-1 + s2)*(-s + s2 - t1)) - 
         (2*(-1 + s1)*(-s + s1 - t2)*
         ...
         ((s - s1 + t2)*(9 + 2*s2 - t1 + 
              ...
              s1*(-5 + s2*(-1 + t2) + 5*t2 - 2*t1*t2 + 2*Power(t2,2)) + 
              s*(8 + t1 - 5*t2 + s1*(4 - t1 + t2))))/(-1 + t2) - 
         ((-1 + s1)*(24 - 12*s2 + 12*t1 + Power(s1,2)*(6 - s2 + t1) - 
              27*t2 + 4*s2*t2 - t1*t2 + 11*Power(t2,2) - 
              s2*Power(t2,2) + Power(s,2)*(8 - 2*s1 - t1 + t2) - 
              s1*(-19 + 17*t2 - 2*s2*t2 + t1*(3 + t2)) + 
              s*(-15 + 2*Power(s1,2) + 4*s2 - t1 + 19*t2 - s2*t2 - 
                 t1*t2 + Power(t2,2) + s1*(s2 - 3*(6 + t2)))))/
          (s - s2 + t1))/
       (Power(Pi,2)*Power(-1 + s1,2)*Power(s - s1 + t2,2)))*Log(4.));
